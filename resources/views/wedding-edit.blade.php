...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') {{$wedding->name_tr}} Düzenleme @endslot
    @endcomponent
    ...
    <div class="card">
        <form method="POST" class="form-horizontal" action="/update-wedding/{{$wedding->id}}" enctype="multipart/form-data">
            @csrf
        <div class="card-body">
                <h4 class="card-title mb-4">Organizasyon Düzenle</h4>
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name_tr" value="{{$wedding->name_tr}}" name="name_tr"  autofocus required>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="name_en" class="col-sm-3 col-form-label">Etkinlik Adı (EN)</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name_en" value="{{$wedding->name_en}}" name="name_en"  autofocus required>
                            </div>
                        </div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active"  {{$wedding->is_active ==1?"checked":""}}>
