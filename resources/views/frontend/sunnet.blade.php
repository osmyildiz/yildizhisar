                                ...
                                <div class="restbeef_block_inner">
                                    <div class="restbeef_content_box02 align_center">
                                        @if(app()->getLocale() == "tr")
                                            ...
                                            <p>Yüzlerce yıllık zengin bir tarihe ev sahipliği yapan Rumeli Hisarı’nda konumlanan işletmemiz, oğlunuzun bu kıymetli gününe ihtişam katmak için sizleri bekliyor. Davetlilerinizi ağırlarken güvenle sırtınızı yaslayabileceğiniz tecrübeli ekibimiz ile hem heyecanınıza ortak olacak hem de davetinizin mükemmel bir deneyime dönüşmesini sağlayacağız. </p>
                                @else

                                       <p>
                                           Located in Rumeli Hisarı, which hosts a rich history of hundreds of years, our business is waiting for you to add splendor to this precious day of your son. With our experienced team, which you can safely lean on while hosting your guests, we will both share your excitement and ensure that your invitation turns into an excellent experience.
