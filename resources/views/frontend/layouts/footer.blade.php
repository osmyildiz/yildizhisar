...
<div class="restbeef_footer restbeef_container_wide">
    ...
    <div class="restbeef_copyright" style="font-size: 14px">
        <a href="/img/aydinlatma_metni.pdf"  target="_blank" style="font-size: 14px"  >Aydınlatma Metni</a>
        <a href="/img/kvkk.docx" style="font-size: 14px"  target="_blank" >| KVKK Başvuru Formu</a>
