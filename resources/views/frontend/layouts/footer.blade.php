        ...
        <div class="row">
            ...
            <div class="col-4 align_center">
                <div class="widget widget_text">
                    <h2><span class="restbeef_up_title" style="font-size: 50px">@lang('static_text.about1')</span></h2>
                    <div class="textwidget">
                        ...
                        <p style="font-size: 24px">@lang('static_text.open')</p>
                    </div><!-- .textwidget -->
                </div><!-- .widget_text -->
            </div><!-- .col-4 -->
                ...
                <div class="widget widget_in_touch">
                    ...
                    <div class="restbeef_in_touch">
                        <form class="restbeef_intouch_form" name="restbeef_intouch">
                            <input style="font-size: 24px" type="email" placeholder=@lang('static_text.email')>
                            <input style="font-size: 24px" type="submit" value=@lang('static_text.send')>
            ...
            <div class="col-4 align_center">
                <div class="widget widget_text">
                    <h2 ><span style="font-size: 50px" class="restbeef_up_title">@lang('static_text.contact1')</span></h2>
                    <div class="textwidget">
                        <p style="font-size: 24px">Rumeli Hisarı, Salih Bey Sk. No:6,  34470 Sarıyer / İstanbul</p>
                        <p style="font-size: 24px"><span>Tel: </span>+90 212 287 70 45</p>
                        <p style="font-size: 24px">@lang('static_text.open')</p>
