                                ...
                                <div class="restbeef_block_inner">
                                    <div class="restbeef_content_box02 align_center">
                                        @if(app()->getLocale() == "tr")
                                            ...
                                            <p>Müstakbel eşinizle birleştireceğiniz hayatınızda sizlere eşlik edecek yüzükleri parmağınıza taktığınız o an, unutulmazdır… Boğaz’ın büyülü mavisi Nişan davetlerinize çok yakışacak… </p>

                                @else

                                        <p>The moment when you put on the rings that will accompany you in your life, which you will unite with your future spouse, is unforgettable... The magical blue of the Bosphorus will suit your engagement parties very well...</p>
                                @endif
