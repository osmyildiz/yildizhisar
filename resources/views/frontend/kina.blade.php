                            ...
                            <div class="restbeef_block restbeef_team_block restbeef_js_margin"
                                ...
                                <div class="restbeef_block_inner">
                                    <div class="restbeef_content_box02 align_center">
                                        @if(app()->getLocale() == "tr")
                                        <p>Kına gecesinin kadim bir kurum olan evliliğe adım atarken uğur getireceğine inanılır. Yıldız Hisar’daki bir diğer uğurunuz ise masalsı mekânımız ve gecenizi eşsiz kılacak tecrübeli ekibimiz olacak… </p>
                                        @else
                                        <p>It is believed that henna night will bring good luck when stepping into marriage, which is an ancient institution. Another of your luck in Yıldız Hisar will be our fairy-tale venue and our experienced team that will make your night unique.</p>
